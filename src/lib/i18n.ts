...
const translations: Record<Language, Translations> = {
  ...
  ku: {
    ...
    brandTitle: 'چاودێری زەڕی زیندوو',
    brandSub: 'چاودێری زەڕی زیندوو و ئامرازەکان',
    tutorialVideo: 'ڤیدیۆی فێرکاری',
    openTutorialAria: 'کردنەوەی ئاگاداری ڤیدیۆی فێرکاری',
    installApp: 'دامەزراندنی ئەپ',
    ...
    usageNoticeP2:
      'ئەم ماڵپەڕە هیچ پەیوەندیێکی نیە بە هیچ دەزگای فەرمی زەڕ، دەزگای حکومەتی، یان سندیکای جواهره‌فروش (لەوانە سندیکای جواهرەفروشی کوردستان / یەکێتی بازرگانانی زەڕ). ئەم پەڕەیە نرخە فەرمیە ناوخۆیی بەکار ناهێنێت. نرخی ئونسەی زەڕی زیندوو لە داتای بازاڕی جیهانیەوە وەردەگیرێت، و هەموو بەرهەمەکان بە شێوەی خۆکارانە حیساب دەکرێن.',
    usageNoticeP3Intro: 'ئەم پلاتفۆمە ئامرازەکانی خوارەوە لەخۆ دەگرێت:',
    usageNoticeList1:
      'گۆڕینی نرخی ئونسەی زیندوو بۆ نرخی قەرات بە بنەمای کێش (لەوانە حیسابەکانی ٥ گرام / مثقال)',
    usageNoticeList2:
      'پێشبینی مارژن یان زیادەی ناوخۆیی کە زۆرجار لەلایەن ڕێکخەرە بازاڕییەکان یان بازرگانی ناوخۆ دەکرێت (هەڵبژاردەی بەکارهێنەر یان سلایدەر، نە نرخی فەرمی)',
    ...
    connectionNote:
      'تێبینی: ئەگەر پەیوەندی ئینتەرنێتت خاو یان دەرهێڵ بێت، نوێکردنەوەی نرخەکان لەوانە دوا بکەون. نرخە زیندووەکان خۆکارانە لە دابینکەری داتاکە وەردەگیرێن.',
    qualityVeryLow: 'زۆر لاواز',
    qualityLow: 'لاواز',
    qualityGood: 'باش',
    qualityStrong: 'بەهێز',
    expectationTitle: 'پێشبینی',
    whatIfCalculator: 'حیسابکەری ئەگەر-بێت',
    expectedOuncePrice: 'نرخی پێشبینی ئونس',
    placeholderExpectedOunce: 'وەک نمونە 4900.50',
    hintExpectedOunce: 'نرخی پێشبینی XAU (USD بۆ هەر ئونس) بنوسە.',
    usdToIqd: 'USD → IQD',
    placeholderUsdToIqd: 'وەک نمونە 1500',
    hintIfFilledResultIqd: 'ئەگەر نووسرا، ئەنجام بە IQD دەبێت.',
    mithqal: 'مثقال (٥ گرام)',
    gram: 'گرام',
    includesMargin: ({ value }) => `لەخۆگرتنی مارژن: ${value} IQD`,
    addUsdToIqdEnableMargin: 'USD→IQD زیاد بکە بۆ چالاککردنی سلایدەری مارژنی IQD.',
    expectationMargin: 'مارژنی پێشبینی (IQD)',
    enableByEnteringUsdToIqd: 'بە نووسینی USD→IQD چالاک دەبێت',
    karatsTitle: 'قەرات',
    leaveEmptyForUsd: 'بەتاڵ بهێڵە بۆ USD',
    karatsHint: 'بەهایەک بنوسە بۆ گۆڕینی نرخی قەرات بۆ IQD. نرخی ئونس زیندوو لە USD دەماوێتەوە.',
    waiting: 'چاوەڕوانی…',
    marginTax: 'مارژن / باج (IQD)',
    sliderWorksNote: 'سلایدەر تەنها بۆ نرخی قەراتی IQD کار دەکات. ئونس کاریگەر نیە.',
    taxMarginSolveTitle: 'چارەسەری باج / مارژن',
    autoSyncSlider: 'هاوڕێکخستنی خۆکار',
    localOuncePriceUsd: 'نرخی ئونس لە ناوخۆ (USD)',
    localOuncePlaceholder: 'وەک نمونە 4900',
    localOunceHint: 'نرخی ئونسەی زەڕ کە لە ناوخۆ دیتوتە.',
    ...
    marginResult: 'ئەنجامی مارژن',
    applyMarginMainSlider: 'مارژن لە سلایدەری سەرەکی جێگیر بکە',
    marginSolveNote:
      'مارژنی مثقالی ٢١قەرات بە بنەمای زانیارییەکانت حیساب دەکات و سلایدەری مارژنە سەرەکییەکە خۆکارانە نوێ دەکاتەوە.',
    advancedCalculator: 'حیسابکەری پێشکەوتوو',
    ...
    feedbackSub: 'ئایدە بەشێوەی پێشنیار یان کێشە بنووسە',
