...
const translations: Record<Language, Translations> = {
  ...
  ku: {
    ...
    usageNoticeList2:
      'پێشبینی زیادە یان زیادەی ناوخۆیی کە زۆرجار لەلایەن ڕێکخەرە بازاڕییەکان یان بازرگانی ناوخۆ دەکرێت (هەڵبژاردەی بەکارهێنەر یان سلایدەر، نە نرخی فەرمی)',
    ...
    karatsHint: 'بەهایەک بنوسە بۆ گۆڕینی نرخی عەیارەکان بۆ IQD. نرخی ئۆنسەی ڕاستەوخۆ لە USD دەماوێتەوە.',
    waiting: 'چاوەڕوانی…',
